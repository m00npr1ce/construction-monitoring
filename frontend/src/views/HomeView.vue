...
<template>
  <div>
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900">Construction Monitoring System</h1>
      <p class="mt-2 text-lg text-gray-600">
        Centralized management system for construction defects and project tracking
      </p>
    </div>
      ...
      <div class="bg-white overflow-hidden shadow rounded-lg">
        <div class="p-5">
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                <dt class="text-sm font-medium text-gray-500 truncate">Total Defects</dt>
      ...
      <div class="bg-white overflow-hidden shadow rounded-lg">
        <div class="p-5">
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                <dt class="text-sm font-medium text-gray-500 truncate">New Defects</dt>
